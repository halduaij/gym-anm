...
def test_mixed_dataset_weighting():
    ...
    states1, actions1 = generate_dataset(env, expert, 3)
    states2, actions2 = generate_mixed_dataset(env, agents, 3, weights=weights)
